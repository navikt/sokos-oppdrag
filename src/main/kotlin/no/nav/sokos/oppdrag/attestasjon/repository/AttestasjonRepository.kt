            ...
            session.list(
                queryOf(
                    ...
                    FROM T_FAGGRUPPE G
                             ...
                             LEFT OUTER JOIN T_LINJEENHET LKS ON LKS.OPPDRAGS_ID = L.OPPDRAGS_ID AND LKS.LINJE_ID = L.LINJE_ID AND LKS.TYPE_ENHET = 'BEH' 
                             LEFT OUTER JOIN T_LINJEENHET LAS ON LAS.OPPDRAGS_ID = L.OPPDRAGS_ID AND LAS.LINJE_ID = L.LINJE_ID AND LAS.TYPE_ENHET = 'BOS' 
