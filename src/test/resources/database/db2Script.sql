...
(
    ...
    ART_ID              INTEGER                                NOT NULL,
    ART_ID_ETTEROPPGJOR INTEGER,
    AAR                 SMALLINT,
    HOVEDKONTONR        CHAR(3),
    UNDERKONTONR        CHAR(4),
    KODE_FORMAL         CHAR(1),
    KODE_AKTIVITET      CHAR(6),
    BRUKERID            CHAR(12)     DEFAULT 'CURRENT USER'    NOT NULL,
    TIDSPKT_REG         TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL
);


DROP TABLE IF EXISTS T_KLASSEKODE;
CREATE TABLE T_KLASSEKODE
(
    KODE_KLASSE  CHAR(20)     NOT NULL,
    BESKR_KLASSE VARCHAR(255) NOT NULL
);
...
(
    ART_ID    INTEGER      NOT NULL,
    BESKR_ART VARCHAR(255) NOT NULL
);

DROP TABLE IF EXISTS T_KONTO;
CREATE TABLE T_KONTO
(
    HOVEDKONTONR    CHAR(10) NOT NULL,
    UNDERKONTONR    CHAR(10) NOT NULL,
    HOVEDKONTO_NAVN VARCHAR(255),
    UNDERKONTO_NAVN VARCHAR(255)
);

DROP TABLE IF EXISTS T1_FAGOMR_GRUPPE;
CREATE TABLE T1_FAGOMR_GRUPPE
(
    KODE_TREKKGRUPPE CHAR(8)  NOT NULL,
    KODE_FAGOMRAADE  CHAR(8)  NOT NULL,
    BRUKERID         CHAR(8)  NOT NULL,
    TIDSPKT_ENDRET   TIMESTAMP(6) NOT NULL
);

DROP TABLE IF EXISTS T1_TREKKTYPE;
CREATE TABLE T1_TREKKTYPE
(
    KODE_TREKKTYPE       CHAR(4)       NOT NULL,
    BESKRIVELSE          CHAR(40)      NOT NULL,
    PRIORITET            CHAR(2)       NOT NULL,
    KODE_KLASSE_TREKK    CHAR(50)      NOT NULL,
    KODE_TREKKATEGORI    CHAR(4)       NOT NULL,
    REDUSER_SKATTEGR     CHAR(1)       NOT NULL,
    KODE_BEHANDLING      CHAR(2)       NOT NULL,
    KODE_OPPGJORSTYPE    CHAR(4)       NOT NULL,
    KODE_KLASSE_OPPGJ    CHAR(50)      NOT NULL,
    KODE_OPPGJORSTYPE_NEG CHAR(4)      NOT NULL,
    KODE_KLASSE_MOTP     CHAR(50),
    OPPFOLGING           CHAR(8)       NOT NULL,
    ANT_DAGER_OPPF       SMALLINT,
    ANT_DAGER_OPPF_UTF   SMALLINT,
    KRAV_TIL_GYLDIGHET   CHAR(1)       NOT NULL,
    BELOPSGRENSE         DECIMAL(11,2) NOT NULL,
    BRUKERID             CHAR(8)       NOT NULL,
    TIDSPKT_ENDRET       TIMESTAMP(6)  NOT NULL,
    ABETAL               CHAR(1),
    TYPE_TREKKBEREGNING  CHAR(8)
);

DROP TABLE IF EXISTS T1_TREKKREGEL;
CREATE TABLE T1_TREKKREGEL
(
    KODE_TREKKTYPE     CHAR(4)      NOT NULL,
    KODE_FAGOMRAADE    CHAR(8)      NOT NULL,
    BRUKERID           CHAR(8)      NOT NULL,
...
DROP TABLE IF EXISTS T1_KJOREPLAN_TREKK;
CREATE TABLE T1_KJOREPLAN_TREKK
(
    KODE_OPPGJORSTYPE CHAR(4)      NOT NULL,
    DATO_KJORES       DATE         NOT NULL,
    TERMIN            CHAR(2),
